...
def weight_variable(shape):
  ...
  layer_weights = tf.Variable(initial, name='final_weights')
...
def bias_variable(shape):
  ...
  layer_biases = tf.Variable(initial, name='final_biases')
...
if __name__ == '__main__':  
  ...
  parser.add_argument(  
      '--summaries_dir',  
      type=str,  
      default='./v3_mul_imageNet/retrain_logs',  
  ...
  parser.add_argument(  
      '--model_dir',  
      type=str,  
      default='./v3_mul_imageNet/imagenet',  
      help="""\
  ...
  parser.add_argument(  
      '--bottleneck_dir',  
      type=str,  
      default='./v3_mul_imageNet/bottleneck',  
