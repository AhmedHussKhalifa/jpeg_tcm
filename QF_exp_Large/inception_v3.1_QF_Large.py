...
# wb = openpyxl.load_workbook('Accuracy Record ILSVRC2012 QF.xlsx')
# sheet=wb['QF']
    ...
    for i in range(90,81,-10):
        ...
        if os.path.isfile(path):
            ...
            for node_id in top:
                ...
                if rank <= 5:
                    first_5 = first_5 + score
                    if rank == 1:
                        first_1 = score
                if rank > 5 and found == True:
                	sheet.write(ID, 10, first_1.item(), style)
                	sheet.write(ID, 11, first_5.item(), style)
                	break

                # print('%s (score = %.5f)' % (human_string, score))
                if(found == False and Label[ID] == human_string):
                    # -- Original -- 2 3 4 5 6
                    found = True
...
print('Done...')
recordnew.save('Accuracy Record ILSVRC2012 QF-90.xls')
# wb.save('Accuracy Record ILSVRC2012 QF.xlsx')